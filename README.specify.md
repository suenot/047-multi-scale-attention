# Chapter 49: Multi-Scale Attention для Trading

## Описание

Attention механизмы на различных временных масштабах для захвата краткосрочных и долгосрочных паттернов.
...
1. **Multi-Scale Temporal Memory for Financial Time Series**
   - URL: https://arxiv.org/abs/2201.08586
   - Год: 2022
